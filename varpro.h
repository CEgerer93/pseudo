...
namespace VarPro
{
  ...
  */
  ...
  public:
    ...
    varPro() {}
    // Parametrized
    varPro(int _numLT, int _numAZ, int _numT4, size_t numData, int _pdfType)
      {
	pdfType = _pdfType;
	numLT   = _numLT; numAZ = _numAZ; numT4 = _numT4;
	numCorrections = _numLT + _numAZ + _numT4;
