...
namespace VarPro
{
  ...
  */
  ...
  public:
    ...
    int numLT, numAZ, numT4, numT6, numT8, numT10;
    int numCorrections;
    ...
    varPro() {}
    // Parametrized
    varPro(int _numLT, int _numAZ, int _numT4, int _numT6, int _numT8, int _numT10, size_t numData, int _pdfType)
      {
	pdfType = _pdfType;
	numLT   = _numLT; numAZ = _numAZ; numT4 = _numT4; numT6 = _numT6; numT8 = _numT8; numT10 = _numT10;
	numCorrections = _numLT + _numAZ + _numT4 + _numT6 + _numT8 + _numT10;
